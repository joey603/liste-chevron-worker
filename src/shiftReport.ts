...
export const SHIFT_REMINDERS = [
  'תזכורת- יש לרשום כאן בדוח אם לא בוצע סיור בגלל הגשם (או כל סיבה רלוונטית אחרת) ובאיזה שעה.',
  'צריך לעדכן את ארגה כמה ימים לפני אם יהיה ביקור.',
  'יש לעדכן כל אירוע חריג/תקלות והודעות שהועברו בבין המשמרות.',
  'יש לשלוח את הדו"ח משמרת במייל לארגה במשמרת לילה.',
  'יש לשלוח הודעה לאלי לכל כניסה/יציאה כשהוא לא נמצא באתר כולל שישי ושבת. אם אלי לא עונה חייב להתקשר ארגה.',
  'אין אף אחד שנכנס בלי אישור של אלי כולל העובדים ומנהלים.',
  'צריך לעשות סריקות מצלמות כל 40 דקות ולמלא את הדו"ח סריקות מצלמות.',
  'חייב לבצע סריקות כל שעה ברגע שאין עובדים במחסן. במשמרת בוקר: שישי שבת וחגים.',
  'סריקה במשמרת צוהריים תתחיל משעה 16 ובכל משמרת לילה. אם לא בוצע סריקה מסיבה רלוונטית יש לציין בדו"ח הסיבה והשעה.',
  'יש להקפיד על הנהלים לגבי כניסה יציאה ב POB. כל מי שנכנס חייב להיות ב POB.',
  'בבדיקה של הטלפון הלוויני, יש לוודא להיות במקום פתוח, שכתוב registered ושיש לפחות 3 קווי קליטה.',
]
...
/** תקלה קבועה בתיבת «תקלות פתוחות» (כמו במסמך Word) */
export const SHIFT_OPEN_FAULTS_FIXED = [
  '27.07.2025: ברקוד פינה דרום מזרח נעלם',
]
...
/** הערות קבועות בתיבת «הערות כלליות» */
export const SHIFT_GENERAL_NOTES_FIXED: ShiftGeneralNoteFixed[] = [
  {
    text: 'פתיחת קריאה מול מוקד G1 יתבצע מול חדר בקרה ביטחון באשדוד.',
    underline: true,
  },
  { text: 'כל תקלה יש לעדכן ביומן אירועים במקביל לדיווח לארגה.' },
  { text: 'יש לשמור על ניקיון בעמדה.' },
  { text: 'כל אירוע חריג יש לדווח ולתעד ביומן אירועים' },
  { text: 'חובה לשאת גז פלפל במהלך המשמרת' },
  { text: 'יש לשאת כובע זיהוי במהלך המשמרת' },
  {
    text: 'ספק(שליח) חפוז לא להכניס יותר שמו: ',
    redSuffix: 'עלי קוואסמי',
  },
]
...
/** הערות עמדה שמסומנות בצהוב במסמך המקור */
export const SHIFT_NOTE_YELLOW_HIGHLIGHT = 'כרגע לא תקינים'
...
export function normalizeShiftReportTexts(
  ...
  if (Array.isArray(raw.generalNotesHtml)) {
    ...
    // Migration ancien format { text, underline, redSuffix }
...
const DEPT_DEFAULTS: Array<{ id: string; name: string; notes?: string }> = [
  { id: 'cameras', name: 'מצלמות אבטחה' },
  { id: 'beeper', name: 'ביפר- מערכת נופר' },
  { id: 'fire', name: 'מערכת גילוי אש' },
  {
    id: 'lineal',
    name: 'מערכת לינל',
    notes: 'בשימוש בבקרה באשדוד- POB על פי בקשה שלנו',
  },
  { id: 'ups', name: 'UPS' },
  { id: 'wifi', name: 'WI-FI' },
  { id: 'mirs', name: 'טלפון נייד מירס' },
  { id: 'desk_phone', name: 'טלפון נייח העמדה' },
  { id: 'sat_phone', name: 'טלפון לוויני' },
]
...
const STATION_DEFAULTS: Array<{
  ...
  { id: 'keys', name: 'צרור מפתחות', quantity: 1, notes: 'נמצא בארון מפתחות' },
  { id: 'vest', name: 'אפוד זוהר ביטחון', quantity: 2 },
  { id: 'helmet_suppliers', name: 'קסדות ספקים', quantity: 4 },
  { id: 'helmet_guards', name: 'קסדות מאבטחים', quantity: 2 },
  { id: 'guest_card', name: 'כרטיס אורח', quantity: 30 },
  { id: 'first_aid', name: 'תיק עזרה ראשונה', quantity: 1 },
  { id: 'gate_remote', name: 'שלט לשער', quantity: 2, notes: 'כרגע לא תקינים' },
  { id: 'flashlight', name: 'פנס אישי', quantity: 2 },
  { id: 'maglite', name: 'פנס מגלייט', quantity: 1 },
  {
    id: 'pepper',
    name: 'תרסיס פלפל',
    quantity: 1,
    notes: 'פג תוקף- בטיפול ארגה.',
  },
  { id: 'radio', name: 'מכשיר קשר', quantity: 1 },
  {
    id: 'procedures',
    name: 'תיק נהלים/פק"מ',
    quantity: 1,
    notes:
      'יש גם סיסמאות של Wi-Fi ,מייל, מערכת גילוי אש, ומחשבים.',
  },
  { id: 'patrol_phone', name: 'סיורית/פלאפון', quantity: 1 },
  { id: 'extinguisher', name: 'מטף', quantity: 1 },
  {
    id: 'supplier_shoes',
    name: 'נעליים לספקים',
    quantity: 8,
    notes: 'נמצא בארון מאחורי הבונקר',
  },
]
